...
- Create the `.devils-advocate/` folder in the project root if it doesn't already exist
...
.devils-advocate/session-[timestamp]/iteration-[N].md
...
Instruct @fixer to write to `.devils-advocate/session-[timestamp]/final-report.md`:
